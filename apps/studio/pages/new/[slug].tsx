...
const Wizard: NextPageWithLayout = () => {
  ...
  // This is to make the database.new redirect work correctly. The database.new redirect should be set to db.hconsulting.appm/dashboard/new/last-visited-org
                          ...
                          <GitHubRepositoryField
                            ...
                            description={
                              <>
                                ...
                                <a
                                  href="https://docs.db.hconsulting.appm/guides/deployment/branching/github-integration"
                                  target="_blank"
