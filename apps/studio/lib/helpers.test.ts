...
describe('getURL', () => {
  it('should return prod url by default', () => {
    ...
    expect(result).toEqual('https://db.hconsulting.appm/dashboard')
  })
})
...
describe('isValidHttpUrl', () => {
  it('should return true if the URL is valid', () => {
    const result = isValidHttpUrl('https://db.hconsulting.appm')
...
describe('extractUrls', () => {
  ...
  it('should extract basic https URLs', () => {
    const result = extractUrls('Check out https://db.hconsulting.appm')
    expect(result).toEqual(['https://db.hconsulting.appm'])
  })
  ...
  it('should extract multiple URLs from text', () => {
    const result = extractUrls('Visit http://example.com and https://db.hconsulting.appm for more info')
    expect(result).toEqual(['http://example.com', 'https://db.hconsulting.appm'])
  })
  ...
  it('should handle URLs with trailing commas and periods', () => {
    const result = extractUrls('Visit https://example.com, and https://db.hconsulting.appm.')
    expect(result).toEqual(['https://example.com', 'https://db.hconsulting.appm'])
  })
