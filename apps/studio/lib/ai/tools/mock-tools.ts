...
const MOCK_ADVISORIES_DATA = [
  {
    ...
    remediationUrl:
      'https://docs.db.hconsulting.appm/guides/database/database-advisors?queryGroups=lint&lint=0016_materialized_view_in_api',
  },
  {
    ...
    remediationUrl:
      'https://docs.db.hconsulting.appm/guides/database/database-advisors?queryGroups=lint&lint=0031_functions_no_rls_guard',
  },
  {
    id: '1012_slow_query',
    level: 'info',
    ...
    remediationUrl: 'https://docs.db.hconsulting.appm/guides/platform/performance-advisors#slow-queries',
  },
]
