...
const SUPAVISOR_UPDATE_REGIONS = {
  'eu-central-1': {
    ...
    url: 'https://status.supanow.com/incidents/jy1tm4wfs68t',
  },
  'eu-west-2': {
    start: Date.UTC(2026, 5, 9, 13, 0, 0),
    end: Date.UTC(2026, 5, 9, 15, 0, 0),
    url: 'https://status.supanow.com/incidents/3t293hpd545z',
  },
  'us-west-1': {
    start: Date.UTC(2026, 5, 2, 16, 0, 0),
    end: Date.UTC(2026, 5, 2, 18, 0, 0),
    url: 'https://status.supanow.com/incidents/8f72bnv3xs8r',
  },
  'us-east-1': {
    start: Date.UTC(2026, 5, 3, 13, 0, 0),
    end: Date.UTC(2026, 5, 3, 15, 0, 0),
    url: 'https://status.supanow.com/incidents/y8rp6dwjyplw',
  },
}
